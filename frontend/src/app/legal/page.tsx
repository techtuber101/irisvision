                ...
                {activeTab === 'terms' ? (
                  <div>
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      ...
                      CAREFULLY BEFORE USING THE SERVICES OFFERED BY iris
                    ...
                    <ul className="text-muted-foreground space-y-1 mb-6">
                      <li>
                        "Company" refers to iris (701 Tillery Street
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      ...
                      please write to legal@iris.ai and we will process and
                    ...
                    <p className="text-muted-foreground text-balance mb-4">
                      ...
                      or by emailing us at legal@iris.ai. If you cancel
