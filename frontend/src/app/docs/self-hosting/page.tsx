...
cd irissecond`
      ...
      <DocsBody className="mb-8">
        <h2 id="step-5-start">Step 5: Start the app</h2>
...
docker compose down`
      ...
      <DocsBody className="mb-8">
        ...
        <p className="mb-4">You should see the dashboard where you can start chatting with Iris or create your own agents.</p>
