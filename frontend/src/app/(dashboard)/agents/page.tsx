...
export default function AgentsPage() {
  ...
  const [marketplaceFilter, setMarketplaceFilter] = useState<'all' | 'iris' | 'community' | 'mine'>('all');
  ...
  const marketplaceQueryParams = useMemo(() => {
    ...
    if (marketplaceFilter === 'iris') {
      params.is_iris_team = true;
    } else if (marketplaceFilter === 'community') {
      params.is_iris_team = false;
