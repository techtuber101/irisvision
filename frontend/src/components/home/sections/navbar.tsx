        ...
        >
          <div className="flex h-[56px] items-center justify-between px-4 md:px-6">
            ...
            <Link href="/" className="flex items-center gap-3">
              <Image src="/irislogoblack.png?v=2" alt="Iris Logo" width={140} height={22} className="dark:hidden" priority />
              <Image src="/irislogowhitebig.png?v=2" alt="Iris Logo" width={140} height={22} className="hidden dark:block" priority />
            </Link>
            ...
            >
              <div className="flex flex-col gap-4">
                <div className="flex items-center justify-between">
                  <Link href="/" className="flex items-center gap-3">
                    <Image src="/irislogoblack.png?v=2" alt="Iris Logo" width={120} height={22} className="dark:hidden" priority />
                    <Image src="/irislogowhitebig.png?v=2" alt="Iris Logo" width={120} height={22} className="hidden dark:block" priority />
