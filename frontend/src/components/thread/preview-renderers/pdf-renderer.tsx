...
const PageSkeleton = ({ height, width, pageNumber }: { height: number; width: number; pageNumber: number }) => (
    <div
        className="border border-white/10 rounded-md bg-[rgba(15,23,42,0.4)] w-full flex flex-col items-center justify-center text-[10px] text-white/60"
...
export function PdfRenderer({ url, className }: PdfRendererProps) {
    ...
    const renderedPages = useMemo(() => {
        ...
        expandAround(currentPage, 2);
        pagesNearViewport.forEach(page => expandAround(page, 1));
            ...
            >
                <div className="w-full max-w-3xl mx-auto py-3 px-2">
                    <Document
                        ...
                        loading={
                            <div className="w-full h-48 flex items-center justify-center text-white/70 text-xs">
                                Loading document...
                            </div>
                        }
                    ...
                    >
                        {numPages > 0 &&
                            pageNumbers.map(pageNumber => {
                                ...
                                return (
                                    <div
                                        key={`inline-pdf-page-${pageNumber}`}
                                    ...
                                    >
                                        {shouldRender ? (
                                            <Page
                                                ...
                                                className="border border-white/10 rounded-md bg-white shadow"
