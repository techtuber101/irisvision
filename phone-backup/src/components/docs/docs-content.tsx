...
const contentSections = [
  {
    id: 'introduction',
    title: 'Introduction',
    description: 'Learn about Iris AI Worker and how it can transform your automation workflows',
    readTime: '5 min read',
    updated: '2 days ago'
  },
  {
  ...
  },
  {
    id: 'installation',
    title: 'Installation',
    description: 'Step-by-step guide to install and configure Iris in your environment',
