...
export const AgentAvatar: React.FC<AgentAvatarProps> = ({ 
  ...
  isIrisDefault: propIsIrisDefault,
  ...
  const isIris = propIsIrisDefault ?? agent?.metadata?.is_iris_default;
  ...
  if (!agent && !propIconName && !propIsIrisDefault && agentId) {
    return (
      <div 
