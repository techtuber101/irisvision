                ...
                {activeTab === 'terms' ? (
                  <div>
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      ...
                      CAREFULLY BEFORE USING THE SERVICES OFFERED BY Iris AI
                      Corp (701 Tillery Street Unit 12-2521 Austin, Texas 78702,
                      United States). THIS AGREEMENT SETS FORTH THE LEGALLY
                      BINDING TERMS AND CONDITIONS FOR YOUR USE OF THE IRIS
                    ...
                    <ul className="text-muted-foreground space-y-1 mb-6">
                      <li>
                        "Company" refers to Iris AI Corp (701 Tillery Street
                        Unit 12-2521 Austin, Texas 78702, United States).
                      </li>
                      <li>
                        "Site" refers to the Iris website, including any related
                        features, content, or applications offered from time to
                        time by the Company.
                      </li>
                      <li>
                        "Service" refers to the Iris website and all related
                      ...
                      <li>
                        ...
                        Company, specifically legal@iris.ai
                      </li>
                      <li>
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      Iris is licensed under the Apache License, Version 2.0.
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      ...
                      please write to legal@irisai.com and we will process and
                    ...
                    <p className="text-muted-foreground text-balance mb-4">
                      ...
                      or by emailing us at legal@irisai.com. If you cancel
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      All Iris logos, marks, and designations are trademarks or
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      ...
                      LIMITATION, THE IRIS WEB APP AND ANY CONTENT) IS PROVIDED
                      ...
                      IRIS DOES NOT GUARANTEE THE ACCURACY, COMPLETENESS, OR
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      References to our "Services" at Iris in this statement
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      Iris does not collect biometric or identifying
