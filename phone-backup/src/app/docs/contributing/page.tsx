...
export default function ContributingPage() {
  return (
    <>
      <DocsHeader
        title="Contributing to iris"
        description="Help make iris better for everyone! We welcome contributions from the community"
      ...
      <section className="mb-12">
        ...
        <DocsBullets variant="check" spacing="default" className="mb-8">
          <DocsBulletItem
            ...
            description="Create your own fork of the iris repository on GitHub"
          />
          <DocsBulletItem
            title="Clone Locally"
      ...
      <section className="mb-12">
        <DocsBody className="mb-8">
          ...
          <p className="text-lg mb-6">
            There are many ways to help improve iris:
          </p>
        </DocsBody>
          ...
          <DocsCard
            ...
            actions={[
              { 
                ...
                variant: 'default',
                onClick: () => window.open('https://github.com/iris-ai/iris/issues', '_blank')
              }
            ]}
          />
        </div>
