...
class EmailService:
    def __init__(self):
        ...
        self.sender_email = os.getenv('MAILTRAP_SENDER_EMAIL', 'team@iris.ai')
        self.sender_name = os.getenv('MAILTRAP_SENDER_NAME', 'iris Team')
    ...
    def send_welcome_email(self, user_email: str, user_name: Optional[str] = None) -> bool:
        ...
        subject = "🎉 Welcome to iris — Let's Get Started "
...
<body>
  <div class="container">
    <div class="logo-container">
      <img src="https://via.placeholder.com/180x60?text=iris" alt="iris Logo" class="logo">
    </div>
    <h1>Welcome to iris!</h1>

    <p>Hi {user_name},</p>

    <p><em><strong>Welcome to iris — we're excited to have you on board!</strong></em></p>
    ...
    <p>Let us know if you need help getting started or have questions — we're always here. You can also join our community Discord.</p>

    

    <p>Thanks again, and welcome to the iris community <span class="emoji">🌞</span></p>

    <p>— The iris Team</p>

    <a href="http://localhost:3000/" class="button">Go to the platform</a>
  </div>
</body>
</html>"""
...
Welcome to iris — we're excited to have you on board!
...
Thanks again, and welcome to the iris community 🌞

— The iris Team

Go to the platform: http://localhost:3000/

---
© 2025 iris. All rights reserved.
You received this email because you signed up for an iris account."""
