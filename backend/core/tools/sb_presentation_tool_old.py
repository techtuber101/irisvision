        ...
        "function": {
            ...
            "parameters": {
                ...
                "properties": {
                    ...
                    "attachments": {
                        "type": "string",
                        "description": "File attachment(s) to deliver with the presentation. Provide a single relative path or a comma-separated / JSON-formatted list (e.g., 'presentations/my/slide_01.html' or '[\"presentations/my/slide_01.html\", \"presentations/my/slide_02.html\"]')."
                    },
                    "presentation_url": {
                        "type": "string",
