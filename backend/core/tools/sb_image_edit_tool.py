...
class SandboxImageEditTool(SandboxToolsBase):
    """Tool for generating or editing images using Google's Imagen 4.0 Generate model."""
    ...
    @openapi_schema(
        {
            ...
            "function": {
                ...
                "description": "Generate a new image from a prompt, or edit an existing image using Google's Imagen 4.0 Generate model. Stores the result in the thread context.",
                "parameters": {
                    "type": "object",
                    "properties": {
                        "mode": {
    ...
    async def image_edit_or_generate(
        ...
        """Generate or edit images using Google's Imagen 4.0 Generate model."""
        try:
