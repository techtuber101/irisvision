...
2. Build a custom image:
   ...
   docker push iris/iris:0.1.3.21
   ```
...
1. Change the `image` parameter in `docker-compose.yml` (that defines the image name `iris/iris:___`)
...
3. Push the new version: `docker push iris/iris:0.1.3`
